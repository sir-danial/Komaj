...
**وضعیت:** جریان کامل خرید فاز ۱ پیاده و روی Darkube مستقر شد — کاتالوگ (وزنی/عددی با مقدار اعشاری) ← سبد ← checkout مهمان ← پرداخت (Zarinpal + درگاه mock) ← تأیید سفارش، به‌علاوه کد تخفیف، ورود اختیاری با OTP، SEO و جستجو. (MVP، ~۱۰ سفارش/هفته، بدون Redis/Postgres/Celery). باقی‌مانده: محاسبه دقیق پست، فاکتور PDF، SMS اعلان سفارش، تست E2E.
